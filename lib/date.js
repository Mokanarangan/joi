...
internals.Date = class extends Any {
    ...
    _base(value, state, options) {
        ...
        if (result.value instanceof Date && !isNaN(result.value.getTime())) {
            ...
            result.errors = this.createError(`date.${type}`, null, state, options, this._code);
        }
    ...
    return function (date) {
        ...
        return this._test(type, date, function (value, state, options) {
            ...
            if (isNow) {
                ...
                if (!compareTo) {
                    return this.createError('date.ref', { ref: date.key }, state, options, code);
                }
            ...
            return this.createError('date.' + type, { limit: new Date(compareTo) }, state, options, code);
        });
    };
};
