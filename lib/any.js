...
module.exports = internals.Any = class {
    ...
    createError(type, context, state, options, code) {

        return Errors.create(type, context, state, options, this._flags, code);
    }
    ...
    _validate(value, state, options, reference) {
        ...
        if (presence === 'optional') {
            ...
            errors.push(this.createError('any.required', null, state, options, this._code));
            return finish();
        }
